...
export declare class Responses extends APIResource {
     ...
     * ```
     */
    retrieve(responseID: string, params?: ResponseRetrieveParamsNonStreaming & ({
    ...
    } | null | undefined), options?: RequestOptions): APIPromise<BetaResponse>;
    retrieve(responseID: string, params: ResponseRetrieveParamsStreaming & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined), options?: RequestOptions): APIPromise<Stream<BetaResponseStreamEvent>>;
    retrieve(responseID: string, params?: (ResponseRetrieveParamsBase & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined)) | undefined, options?: RequestOptions): APIPromise<Stream<BetaResponseStreamEvent> | BetaResponse>;
